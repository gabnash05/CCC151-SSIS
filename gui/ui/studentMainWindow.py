# Form implementation generated from reading ui file 'gui/ui/studentMainWindow.ui'
#
...
"    border-left: 9px solid rgb(93, 180, 190);\n"
"}\n"
"\n"
"/* LINE EDIT */\n"
"#searchBarLineEdit {\n"
...
"}")
        ...
        self.filterComboBox = QtWidgets.QComboBox(parent=self.controlsFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.filterComboBox.setMinimumSize(QtCore.QSize(90, 40))
        self.filterComboBox.setMaximumSize(QtCore.QSize(150, 16777215))
        self.filterComboBox.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        ...
        self.tableHeaderFrame.setMaximumSize(QtCore.QSize(16777215, 70))
        ...
        self.scrollArea = QtWidgets.QScrollArea(parent=self.dataFrame)
        ...
        self.dataTableWidgetContents = QtWidgets.QWidget()
        self.dataTableWidgetContents.setGeometry(QtCore.QRect(0, 0, 768, 406))
        self.dataTableWidgetContents.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.dataTableWidgetContents.setStyleSheet("")
        self.dataTableWidgetContents.setObjectName("dataTableWidgetContents")
        self.gridLayout = QtWidgets.QGridLayout(self.dataTableWidgetContents)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.dataTableFrame = QtWidgets.QFrame(parent=self.dataTableWidgetContents)
        self.dataTableFrame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.dataTableFrame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.dataTableFrame.setObjectName("dataTableFrame")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.dataTableFrame)
        self.verticalLayout_5.setContentsMargins(0, 11, 0, 11)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.rowFrame1 = QtWidgets.QFrame(parent=self.dataTableFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rowFrame1.sizePolicy().hasHeightForWidth())
        self.rowFrame1.setSizePolicy(sizePolicy)
        self.rowFrame1.setMinimumSize(QtCore.QSize(0, 30))
        self.rowFrame1.setMaximumSize(QtCore.QSize(16777215, 40))
        self.rowFrame1.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.rowFrame1.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.rowFrame1.setObjectName("rowFrame1")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.rowFrame1)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.idNumber = QtWidgets.QLabel(parent=self.rowFrame1)
        self.idNumber.setObjectName("idNumber")
        self.horizontalLayout_3.addWidget(self.idNumber)
        self.label = QtWidgets.QLabel(parent=self.rowFrame1)
        self.label.setObjectName("label")
        self.horizontalLayout_3.addWidget(self.label)
        self.label_6 = QtWidgets.QLabel(parent=self.rowFrame1)
        self.label_6.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_3.addWidget(self.label_6)
        self.label_5 = QtWidgets.QLabel(parent=self.rowFrame1)
        self.label_5.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_3.addWidget(self.label_5)
        self.label_4 = QtWidgets.QLabel(parent=self.rowFrame1)
        self.label_4.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_3.addWidget(self.label_4)
        self.label_3 = QtWidgets.QLabel(parent=self.rowFrame1)
        self.label_3.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_3.addWidget(self.label_3)
        self.operationsFrame = QtWidgets.QFrame(parent=self.rowFrame1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"    border-radius: 3px;")
        ...
        self.verticalLayout_5.addWidget(self.rowFrame1)
        self.line_2 = QtWidgets.QFrame(parent=self.dataTableFrame)
...
"")
        ...
        self.rowFrame2 = QtWidgets.QFrame(parent=self.dataTableFrame)
        self.rowFrame2.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.rowFrame2.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.rowFrame2.setObjectName("rowFrame2")
        self.verticalLayout_5.addWidget(self.rowFrame2)
        self.gridLayout.addWidget(self.dataTableFrame, 0, 0, 1, 1)
        self.scrollArea.setWidget(self.dataTableWidgetContents)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.sortByComboBox.setItemText(0, _translate("mainWindow", "a"))
        self.sortByComboBox.setItemText(1, _translate("mainWindow", "b"))
        self.filterComboBox.setPlaceholderText(_translate("mainWindow", "Filter by"))
